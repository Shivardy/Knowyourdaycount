...
<h1 style="color:#34495E">When do you turn 10,000 days old?</h1>
<br>
<label><h4 style="color:#34495E">Enter Birthdate :)</h4></label>
<form class="form-inline" id="formid" role="form" action="findit.php" method="post">

     <label><h4 style="color:#34495E">Day!</h4></label>
  <div class="form-group form-group-lg">
	...
	<label><h4 style="color:#34495E">Month!</h4></label>
	...
	<div class="form-group form-group-lg">
	<label><h4 style="color:#34495E">Year!</h4></label>
...
<button type="submit" id="formbutton" name="submit" class="btn btn-danger btn-lg">Submit <span class="glyphicon glyphicon-check"></span> </button>		
		</form>
</div>
<br>
<br>
